...
HD_PWD='D:/Projects/Vviado/schemotecnics_lab2/schemotecnics_lab2.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log calc_func.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calc_func.tcl -notrace
