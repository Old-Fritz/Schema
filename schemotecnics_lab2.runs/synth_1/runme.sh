...
HD_PWD='D:/Projects/Vviado/schemotecnics_lab2/schemotecnics_lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_func.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calc_func.tcl
